    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(txt_email) || TextUtils.isEmpty(txt_name) || TextUtils.isEmpty(txt_password) || TextUtils.isEmpty(txt_password2)) {

                    Toast.makeText(SignUpActivity.this, "Field(s) cannot be empty!", Toast.LENGTH_SHORT).show();

                }
                if (!TextUtils.equals(txt_password, txt_password2)) {
            ...
            ref.putFile(filePath2).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                ...
                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        profilePicture.setImageURI(filePath2);
                    }
